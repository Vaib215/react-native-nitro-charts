...
namespace margelo::nitro::charts {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NitroPoint).
   */
  struct NitroPoint final {
  public:
  ...
  public:
    NitroPoint() = default;
    explicit NitroPoint(double x, double y): x(x), y(y) {}

  public:
    friend bool operator==(const NitroPoint& lhs, const NitroPoint& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NitroPoint <> JS NitroPoint (object)
  template <>
  struct JSIConverter<margelo::nitro::charts::NitroPoint> final {
    static inline margelo::nitro::charts::NitroPoint fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::charts::NitroPoint(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::charts::NitroPoint& arg) {
